...
alias amxxash="cd && cd /home/xash/cstrike && rm liblist.gam && rm -rf addons && cd .. && wget https://github.com/happyhere-TN/xashds_public_server-vps-_tutorial/raw/refs/heads/main/addons_for_xashds.zip
"
alias extamxxash="unzip addons_for_xashds.zip && rm addons_for_xashds.zip"

#choce-game-engine
echo "tipe the name of game u want: 
xashds   or   hlds"
