...
alias tools="apt install unzip -y && apt install wget -y && apt install apache2 && apt install dialog && apt install screen -y && apt update -y"
alias slgame="cd && chmod +x choiceengine.rc"
